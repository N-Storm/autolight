...
/* Define 2 macros here to enable/disable output to MOSFET on PB4 with pull-up.
 * Using additional internal pullup to drive high level instead of only output high due to
 * PB4 pin has lower drive capability because it's also act as the RESET pin which 
